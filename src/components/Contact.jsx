...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: 'Phone',
      value: '+91 9327849210',
      href: 'tel:+919327849210'
    },
    {
      icon: MapPin,
      label: 'Location',
      value: 'Bardoli, Gujarat, India',
      href: 'https://www.google.com/maps?q=Bardoli,+Gujarat,+India'
    }
  ];
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed transition-colors flex items-center justify-center space-x-2 font-medium"
              >
                {isSubmitting ? (
                  <>
            ...
            <div>
              ...
              <div className="space-y-4">
                {contactInfo.map((info) => (
                  ...
                  >
                    <info.icon className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-4 group-hover:scale-110 transition-transform" />
                    <div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className={`p-3 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${social.color}`}
                  >
                    <social.icon size={24} />
                  </a>
                ))}
